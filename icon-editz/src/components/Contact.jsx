...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setSubmitted(true)
      setStatus({ state: 'success', message: payload.message || 'Thanks for reaching out. I will get back to you soon.' })
              ...
              >
                ...
                {submitted && (
                  <motion.div
                    ...
                    className="rounded-2xl border border-primary/30 bg-primary/10 p-4 text-center text-primary"
                  >
                    Thank you for your message! I&apos;ll get back to you soon.
                  </motion.div>
                )}
                {status ? <FormStatus state={status.state} message={status.message} /> : null}
