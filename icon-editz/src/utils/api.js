...
export const request = async (endpoint, options = {}) => {
    ...
    if (!response.ok) {
        ...
        const error = new Error(typeof errorPayload.error === 'string' ? errorPayload.error : errorPayload.error?.message || errorPayload.message || 'An unknown API error occurred.');
