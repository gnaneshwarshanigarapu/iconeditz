...
export default function HireFromUsPage() {
  ...
  return (
    <AnimatePresence mode="wait">
      {loading ? (
        <PageSkeleton key="hire-skeleton" page="Hire" />
      ) : (
        <motion.div
          key="hire-content"
        ...
        >
          <div className="relative overflow-hidden bg-[#0b0717] py-32 text-white">
            <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_15%_20%,rgba(124,58,237,.25),transparent_28%),radial-gradient(circle_at_80%_70%,rgba(192,38,211,.16),transparent_30%)]" />
